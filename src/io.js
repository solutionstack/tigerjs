                    ...
                    for (i = 0; i < data.elements.length; i++) {
                        ...
                        if (data.elements[i].type === "checkbox") {
                            ...
                            if (data.elements[i].checked)
                                this.postDataFeilds.append(data.elements[i].name, data.elements[i].value);  //only add checked boxes
                ...
                case "HTMLInputElement":
                    if (data.getAttribute("type") === "file") { //if its a file element
                        ...
                        if (data.type === "checkbox") {
                            if (data.checked)
                                this.postDataFeilds.append(data.name, data.value);  //only add checked boxes
